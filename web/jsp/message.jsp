...
<section id="container">
  ...
  <ul class="nav nav-tabs">
   <li class="active"><a href="#lA" data-toggle="tab"><i class=" icon-shopping-cart"></i>Buyer</a></li>
          <li><a href="#lB" data-toggle="tab"><i class="icon-remove"></i>Ebay</a></li>
  ...
  <tbody>
    <tr>
      ...
      <td>
      <!--BEGIN: agreesment-->
          <div id="comment1" class="modal hide fade" align="left">
            ...
            <div class="modal-footer">
              <button href="#" class="button" data-dismiss="modal">Close</button>
                <button href="#" id="respond" class="button" data-dismiss="modal"><i class="icon-edit icon-white"></i>Respond Message</button>
            </div>
          </div>
      
        <!--END: agreesment-->    
      <a class="btn btn-info" data-toggle="modal" href="#comment1"><i class=" icon-comment icon-white"></i>Comment</a></td>
...
<div class="tab-pane" id="lB">
  ...
  <tbody>
    <tr>
      ...
      <td>
      <!--BEGIN: agreesment-->
          <div id="comment" class="modal hide fade" align="left">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h3>Comment</h3>
            </div>
        ...
        <!--END: agreesment-->    
      <a class="btn btn-info" data-toggle="modal" href="#comment"><i class=" icon-comment icon-white"></i>Comment</a></td>
